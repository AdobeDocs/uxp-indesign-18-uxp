...
`;function Si(t){return e.createElement(Ei,{to:t.to})}const $i={left:"90deg",right:"-90deg",up:"-180deg",down:"0"},Ri=re((t=>e.createElement("svg",{className:t.className,style:t.style,version:"1.1",viewBox:"0 0 24 24",x:"0",xmlns:"http://www.w3.org/2000/svg",y:"0","aria-hidden":"true"},e.createElement("polygon",{points:"17.3 8.3 12 13.6 6.7 8.3 5.3 9.7 12 16.4 18.7 9.7 "}))))`
  ...
  polygon {
    fill: ${e=>{let{color:t,theme:r}=e;return t&&r.colors.responses[t]&&r.colors.responses[t].color||t}};
  }
`,Ci=re.span`
  display: inline-block;
  padding: 2px 8px;
...
`,Ti=re(ji)`
  ...
  ${e=>{let{kind:t}=e;return"patternProperties"===t&&G`
      > span.property-name {
...
`,Fi=re.button`
  ...
  ${e=>{let{deprecated:t}=e;return t&&Ai||""}};
...
`;var Qi=r(11258);const Ui=re(Qi.Tabs)`
  > ul {
    list-style: none;
    padding: 0;
    margin: 0;
    ...
    > li {
      ...
      text-align: center;
      outline: none;
      color: ${e=>{let{theme:r}=e;return(0,t.darken)(r.colors.tonalOffset,r.rightPanel.textColor)}};
      margin: 0
        ${e=>{let{theme:t}=e;return`${t.spacing.unit}px ${t.spacing.unit}px ${t.spacing.unit}px`}};
      border: 1px solid ${e=>{let{theme:r}=e;return(0,t.darken)(.05,r.codeBlock.backgroundColor)}};
      border-radius: 5px;
      min-width: 60px;
      font-size: 0.9em;
      font-weight: bold;
...
`,Js=re((t=>{const[r,n]=e.useState(),o=r=>{let{renderCopyButton:o}=r;const a=t.data&&Object.values(t.data).some((e=>"object"==typeof e&&null!==e));return e.createElement(Hs,null,e.createElement(Vi,null,o(),a&&e.createElement(e.Fragment,null,e.createElement("button",{onClick:i}," Expand all "),e.createElement("button",{onClick:s}," Collapse all "))),e.createElement(ue.Consumer,null,(r=>e.createElement(Wi,{className:t.className,ref:e=>n(e),dangerouslySetInnerHTML:{__html:Fs(t.data,r.jsonSampleExpandLevel)}}))))},i=()=>{const e=null==r?void 0:r.getElementsByClassName("collapsible");for(const t of Array.prototype.slice.call(e)){const e=t.parentNode;e.classList.remove("collapsed"),e.querySelector(".collapser").setAttribute("aria-label","collapse")}},s=()=>{const e=null==r?void 0:r.getElementsByClassName("collapsible"),t=Array.prototype.slice.call(e,1);for(const r of t){const e=r.parentNode;e.classList.add("collapsed"),e.querySelector(".collapser").setAttribute("aria-label","expand")}},a=e=>{let t;"collapser"===e.className&&(t=e.parentElement.getElementsByClassName("collapsible")[0],t.parentElement.classList.contains("collapsed")?(t.parentElement.classList.remove("collapsed"),e.setAttribute("aria-label","collapse")):(t.parentElement.classList.add("collapsed"),e.setAttribute("aria-label","expand")))},l=e.useCallback((e=>{a(e.target)}),[]),c=e.useCallback((e=>{"Enter"===e.key&&a(e.target)}),[]);return e.useEffect((()=>(null==r||r.addEventListener("click",l),null==r||r.addEventListener("focus",c),()=>{null==r||r.removeEventListener("click",l),null==r||r.removeEventListener("focus",c)})),[l,c,r]),e.createElement(Ms,{data:t.data},o)}))`
  ${Vs};
`,Ys=t=>{const{source:r,lang:n}=t;return e.createElement(Ji,{dangerouslySetInnerHTML:{__html:St(r,n)}})},Zs=t=>{const{source:r,lang:n}=t;return e.createElement(Ms,{data:r},(t=>{let{renderCopyButton:o}=t;return e.createElement(Hi,null,e.createElement(Vi,null,o()),e.createElement(Ys,{lang:n,source:r}))}))};function Gs(t){let{value:r,mimeType:n}=t;return We(n)?e.createElement(Js,{data:r}):("object"==typeof r&&(r=JSON.stringify(r,null,2)),e.createElement(Zs,{lang:et(n),source:r}))}function Xs(t){let{example:r,mimeType:n}=t;return void 0===r.value&&r.externalValueUrl?e.createElement(Ks,{example:r,mimeType:n}):e.createElement(Gs,{value:r.value,mimeType:n})}function Ks(t){let{example:r,mimeType:n}=t;const o=function(t,r){const[,n]=(0,e.useState)(!0),o=(0,e.useRef)(void 0),i=(0,e.useRef)(void 0);return i.current!==t&&(o.current=void 0),i.current=t,(0,e.useEffect)((()=>{(()=>{return e=this,i=function*(){n(!0);try{o.current=yield t.getExternalValue(r)}catch(e){o.current=e}n(!1)},new Promise(((t,r)=>{var n=e=>{try{s(i.next(e))}catch(e){r(e)}},o=e=>{try{s(i.throw(e))}catch(e){r(e)}},s=e=>e.done?t(e.value):Promise.resolve(e.value).then(n,o);s((i=i.apply(e,null)).next())}));var e,i})()}),[t,r]),o.current}(r,n);return void 0===o?e.createElement("span",null,"Loading..."):o instanceof Error?e.createElement(Ji,null,"Error loading external example: ",e.createElement("br",null),e.createElement("a",{className:"token string",href:r.externalValueUrl,target:"_blank",rel:"noopener noreferrer"},r.externalValueUrl)):e.createElement(Gs,{value:o,mimeType:n})}const ea=re.div`
  padding: 0.9em;
  background-color: ${e=>{let{theme:r}=e;return(0,t.transparentize)(.6,r.rightPanel.backgroundColor)}};
  margin: 0 0 10px 0;
  display: block;
  font-family: ${e=>{let{theme:t}=e;return t.typography.headings.fontFamily}};
  font-size: 0.929em;
...
`,ta=re.span`
  ...
  left: 12px;
  font-weight: ${e=>{let{theme:t}=e;return t.typography.fontWeightBold}};
  color: ${e=>{let{theme:r}=e;return(0,t.transparentize)(.3,r.rightPanel.textColor)}};
`,ra=re.div`
  position: relative;
`,na=re(ps)`
  label {
  ...
  &:focus-within {
    border: none;
    box-shadow: none;
    background-color: ${e=>{let{theme:r}=e;return(0,t.transparentize)(.3,r.rightPanel.backgroundColor)}};
  }
`,oa=re.div`
  font-family: ${e=>e.theme.typography.code.fontFamily};
  font-size: 12px;
  color: #ee807f;
`;class ia extends e.Component{constructor(){super(...arguments),this.state={activeIdx:0},this.switchMedia=e=>{let{idx:t}=e;void 0!==t&&this.setState({activeIdx:t})}}render(){const{activeIdx:t}=this.state,r=this.props.mediaType.examples||{},n=this.props.mediaType.name,o=e.createElement(oa,null,"No sample"),i=Object.keys(r);if(0===i.length)return o;if(i.length>1){const o=i.map(((e,t)=>({value:r[e].summary||e,idx:t}))),s=r[i[t]],a=s.description;return e.createElement(sa,null,e.createElement(ra,null,e.createElement(ta,null,"Example"),this.props.renderDropdown({value:o[t].value,options:o,onChange:this.switchMedia,ariaLabel:"Example"})),e.createElement("div",null,a&&e.createElement(As,{source:a}),e.createElement(Xs,{example:s,mimeType:n})))}{const t=r[i[0]];return e.createElement(sa,null,t.description&&e.createElement(As,{source:t.description}),e.createElement(Xs,{example:t,mimeType:n}))}}}const sa=re.div`
  margin-top: 15px;
`;var aa=r(38122);const la=re(Ti)`
  button {
    background-color: transparent;
    border: 0;
    outline: 0;
...
`,ba=re(ca)`
  border-radius: 2px;
  word-break: break-word;
  ${e=>{let{theme:r}=e;return`\n    background-color: ${(0,t.transparentize)(.95,r.colors.text.primary)};\n    color: ${(0,t.transparentize)(.1,r.colors.text.primary)};\n\n    padding: 0 ${r.spacing.unit}px;\n    border: 1px solid ${(0,t.transparentize)(.9,r.colors.text.primary)};\n    font-family: ${r.typography.code.fontFamily};\n}`}};
  & + & {
    margin-left: 0;
  }
  ${ne("ExampleValue")};
`,xa=re(ba)``,va=re(ca)`
  border-radius: 2px;
  ${e=>{let{theme:r}=e;return`\n    background-color: ${(0,t.transparentize)(.95,r.colors.primary.light)};\n    color: ${(0,t.transparentize)(.1,r.colors.primary.main)};\n\n    margin: 0 ${r.spacing.unit}px;\n    padding: 0 ${r.spacing.unit}px;\n    border: 1px solid ${(0,t.transparentize)(.9,r.colors.primary.main)};\n}`}};
  & + & {
    margin-left: 0;
  }
  ${ne("ConstraintItem")};
...
`;function Jl(t){let{children:r,height:n}=t;const o=e.createRef(),[i,s]=e.useState(!1),[a,l]=e.useState(!1);return e.useEffect((()=>{o.current&&o.current.clientHeight+20<o.current.scrollHeight&&l(!0)}),[o]),e.createElement(e.Fragment,null,e.createElement(Yl,{ref:o,className:i?"":"container",style:{height:i?"auto":n}},r),e.createElement(Zl,{dimmed:!i},a&&e.createElement(Gl,{onClick:()=>{s(!i)}},i?"See less":"See more")))}const Yl=Y().div`
  overflow-y: hidden;
`,Zl=Y().div`
  text-align: center;
  line-height: 1.5em;
...
`;function $c(e,t,r){let{theme:n}=t;return e>1?n.sidebar.level1Items[r]:1===e?n.sidebar.groupItems[r]:""}const Rc=re.ul`
  margin: 0;
  padding: 0;
...
`,Ac={0:G`
  ...
  ${e=>{let{depth:t,type:r,theme:n}=e;return"section"===r&&t>1&&"padding-left: "+8*n.spacing.unit+"px;"||""}}
  display: flex;
...
`,jc=re.span`
  ...
  text-overflow: ellipsis;
`,Ic=re.div`
  ${e=>{let{theme:r}=e;return G`
    font-size: 0.8em;
    margin-top: ${2*r.spacing.unit}px;
    text-align: center;
    position: fixed;
    width: ${r.sidebar.width};
    bottom: 0;
    ...
    a:visited,
    a:hover {
      color: ${r.sidebar.textColor} !important;
      padding: ${r.spacing.unit}px 0;
      border-top: 1px solid ${(0,t.darken)(.1,r.sidebar.backgroundColor)};
      text-decoration: none;
      display: flex;
      align-items: center;
      justify-content: center;
...
`,Tc=re.button`
  ...
  ${Ri} {
    polygon {
      fill: ${e=>{let{theme:r}=e;return(0,t.darken)(r.colors.tonalOffset,r.colors.gray[100])}};
    }
  }
`,_c=re.span`
...
`,Dc=re((t=>{const{name:r,opened:n,className:o,onClick:i,httpVerb:s,deprecated:a}=t;return e.createElement(Tc,{className:o,onClick:i||void 0},e.createElement(Lc,{type:s},bt(s)),e.createElement(Ri,{size:"1.5em",direction:n?"down":"right",float:"left"}),e.createElement(_c,{deprecated:a},r),a?e.createElement(Ci,{type:"warning"}," ",L("deprecated")," "):null)}))`
  ...
  cursor: pointer;
  outline-color: ${e=>{let{theme:r}=e;return(0,t.darken)(r.colors.tonalOffset,r.colors.gray[100])}};
`,zc=re.div`
  padding: 10px 25px;
...
`,Hu=re.input.attrs((()=>({className:"search-input"})))`
  ...
  border-bottom: 1px solid
    ${e=>{let{theme:r}=e;return((0,t.getLuminance)(r.sidebar.backgroundColor)>.5?t.darken:t.lighten)(.1,r.sidebar.backgroundColor)}};
  font-family: ${e=>{let{theme:t}=e;return t.typography.fontFamily}};
  font-weight: bold;
  font-size: 13px;
...
`,Yu=re.div`
  ...
  background-color: ${e=>{let{theme:r}=e;return(0,t.darken)(.05,r.sidebar.backgroundColor)}}};
  color: ${e=>e.theme.sidebar.textColor};
  min-height: 150px;
  max-height: 250px;
  border-top: ${e=>{let{theme:r}=e;return(0,t.darken)(.1,r.sidebar.backgroundColor)}}};
  border-bottom: ${e=>{let{theme:r}=e;return(0,t.darken)(.1,r.sidebar.backgroundColor)}}};
  margin-top: 10px;
  line-height: 1.4;
  font-size: 0.9em;
  ...
  ${Pc} {
    ...
    &:hover,
    &.active {
      background-color: ${e=>{let{theme:r}=e;return(0,t.darken)(.1,r.sidebar.backgroundColor)}};
    }
